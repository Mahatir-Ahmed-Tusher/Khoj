    ...
    >
      <div className="relative">
        ...
        <button
          ...
          className={`absolute right-20 md:right-28 top-3 p-1.5 md:p-2 transition-all duration-200 ${
            isAIImageCheckMode
        ...
        <button
          type="button"
          onClick={handleImageSearchClick}
          className="absolute right-14 md:right-20 top-3 p-1.5 md:p-2 transition-opacity duration-200 hover:opacity-70"
          title="Image Search"
        >
          <Image
