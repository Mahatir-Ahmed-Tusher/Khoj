...
export default function MythbustingSidebar({ className = '', searchHistory = [], onLoadReport, onClearHistory }: MythbustingSidebarProps) {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-lg border border-gray-200 p-6 ${className}`}>
      <div className="mb-6">
        <h3 className="text-lg font-bold text-gray-600 font-solaiman-lipi mb-2 animate-pulse bg-gradient-to-r from-gray-500 to-gray-700 bg-clip-text text-transparent drop-shadow-lg">
            ...
            <div className="space-y-3">
              ...
              <div className="relative w-full h-32 rounded-lg overflow-hidden bg-gray-200">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3">
                  <h4 className="text-white font-semibold text-sm font-solaiman-lipi line-clamp-2 group-hover:text-gray-200 transition-colors duration-200">
                    {article.title}
                  </h4>
                </div>
              </div>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <Link
          href="/factchecks"
          className="block text-center text-gray-600 hover:text-gray-700 font-medium font-solaiman-lipi transition-colors duration-200"
        >
          সব মিথবাস্টিং দেখুন →
        </Link>
      </div>
