...
export default function PromotionalWidget() {
  ...
  return (
    <>
      {/* Desktop Widget */}
      <div className="hidden lg:block bg-white rounded-lg shadow-md p-4 sticky bottom-4 max-h-[500px] overflow-hidden">
      ...
      <div
        className={`lg:hidden fixed top-0 right-0 h-full w-72 bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-40 ${
            ...
            <div className="space-y-2">
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-50 transition-all duration-200 group-hover:shadow-sm">
                    <div
                      className={`p-1.5 rounded-lg text-white ${feature.color}`}
                    >
                      {feature.icon}
                    </div>
                    <div className="flex-1 min-w-0">
