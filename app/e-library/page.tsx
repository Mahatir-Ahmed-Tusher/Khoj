...
const downloadableBooks: DownloadableBook[] = [
  {
    ...
    downloadLink:
      "https://drive.google.com/file/d/18p1DIukP1hZ4jgiglmpmXS7GeNvg2J1L/view?usp=sharing",
  ...
  },
  {
    ...
    downloadLink:
      "https://drive.google.com/file/d/1_Cg5GWJpuj70rPH6W7RdlQVsjGqX0Htm/view?usp=sharing",
  ...
  },
  {
    ...
    downloadLink:
      "https://drive.google.com/file/d/1gO2-c9e_2Xo4LpsThdi35p2AiL0tpU6H/view?usp=sharing",
  ...
  },
  {
    ...
    downloadLink:
      "https://drive.google.com/file/d/1LclnM0IKBXfLtjEnv5Kpj-TfQkfFA4Lk/view?usp=sharing",
  ...
  },
  {
    ...
    downloadLink:
      "https://drive.google.com/file/d/15Z53l-DFgK9wZh75dz7MTVI5pSgu1auD/view?usp=sharing",
  ...
  },
  {
    ...
    downloadLink:
      "https://cdn.penguin.co.uk/dam-assets/books/9780241630181/9780241630181-sample.pdf",
  ...
  },
  {
    ...
    review:
      'এই বইটি তত্ত্বভিত্তিক—তবে অত্যন্ত কার্যকর। লেখকদ্বয় দেখিয়েছেন, অসত্য বিশ্বাস কিভাবে সমাজে নেটওয়ার্কের মাধ্যমে ছড়িয়ে পড়ে। গোষ্ঠী-চাপ, পুনরাবৃত্তি, এবং অসত্য তথ্যের শক্তিশালী উপস্থাপন—এসব কীভাবে "সত্যের বিকল্প" তৈরি করে তা এখানে বিশ্লেষণ করা হয়েছে।\n\nfact-checker এর জন্য বইটি বোঝা জরুরি, কারণ এটি শেখায় কেন সত্য বললেও অনেকে বিশ্বাস করে না। অর্থাৎ, শুধু প্রমাণ নয়, মানুষের সামাজিক মানসিকতাও বুঝতে হয়।',
    downloadLink:
      "https://cdn.bookey.app/files/pdf/book/en/the-misinformation-age.pdf",
  ...
  },
  {
    ...
    downloadLink:
      "https://cdn.bookey.app/files/pdf/book/en/the-half-life-of-facts.pdf",
  ...
  },
  {
    ...
    downloadLink:
      "https://cdn.bookey.app/files/pdf/book/en/trust-me--i'm-lying.pdf",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <p className="text-lg text-gray-800 font-tiro-bangla">
              বই পড়ুন, শিখুন, ভাবুন, এবং খোঁজ-এর সাথে যুক্ত হয়ে জ্ঞানের আলোকে
              আলোকিত হোন!
            </p>
          </div>
        </div>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="border-t pt-4">
                      ...
                      >
                        ডাউনলোডঃ বইটি পড়তে ডাউনলোড করুন{" "}
                        <span className="underline">এখানে</span>।
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="border-t pt-4">
                      ...
                      >
                        কেনার জন্যঃ বইটি কিনতে ক্লিক করুন{" "}
                        <span className="underline">এখানে</span>।
                      </a>
                    </div>
                  </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
          ...
          <div className="text-gray-700 font-tiro-bangla leading-relaxed text-lg text-center">
            আমাদের ই-গ্রন্থাগারে আপনি পাবেন ফ্যাক্ট চেকিং, যুক্তিবাদ, বিজ্ঞান,
            এবং সঠিক তথ্য যাচাই সম্পর্কিত বইয়ের বিশাল সম্ভার। কিছু বই
            বিনামূল্যে ডাউনলোড করে পড়তে পারবেন, আবার কিছু বই বিভিন্ন বইয়ের
            দোকান থেকে কিনে পড়তে পারবেন। প্রতিটি বইয়ের সাথে বিস্তারিত
            পর্যালোচনা দেওয়া হয়েছে যাতে আপনি সঠিক বইটি বেছে নিতে পারেন।
          </div>
        </div>
      </div>
