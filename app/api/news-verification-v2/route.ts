...
- **VERDICT CLARITY:** In the Verdict section, clearly state ONE of: "সত্য" (True), অসত্য  (False), "ভ্রান্ত তথ্য" (Misleading), or "অযাচাইকৃত" (Unverified). Be explicit and unambiguous. Use strong, definitive language like "স্পষ্টভাবে সত্য" (clearly true), "নিঃসন্দেহে মিথ্যা" (undoubtedly false), or "স্পষ্টতই ভ্রান্ত" (clearly misleading).
