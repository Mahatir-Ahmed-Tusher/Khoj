...
async function uploadToImgur(imageBuffer: Buffer, filename: string): Promise<string> {
...
async function generateEnglishReport(imageUrl: string, sightengineResult: any): Promise<string> {
...
export async function PUT(request: NextRequest) {
  try {
    ...
    try {
      ...
      const englishReport = await generateEnglishReport(imageUrl, sightengineResult)
      console.log('English report generated, translating to Bengali with Gemini...')
