...
function generateFallbackReferences(query: string) {
  const fallbackSources = [
    {
      ...
      snippet:
        "বাংলাদেশের মুক্তিযুদ্ধের ইতিহাস, ঘটনা, এবং গুরুত্বপূর্ণ ব্যক্তিত্ব সম্পর্কে বিস্তারিত তথ্য।",
    },
    {
      title: "বাংলাদেশের স্বাধীনতা যুদ্ধ - উইকিপিডিয়া",
      url: "https://bn.wikipedia.org/wiki/বাংলাদেশের_স্বাধীনতা_যুদ্ধ",
      snippet:
        "বাংলাদেশের মুক্তিযুদ্ধের বিস্তারিত ইতিহাস, কারণ, ঘটনাপ্রবাহ এবং ফলাফল।",
    },
    {
      title: "মুক্তিযুদ্ধের ইতিহাস - বাংলাদেশ সরকার",
      url: "https://www.bangladesh.gov.bd",
      snippet:
        "বাংলাদেশ সরকারের অফিশিয়াল ওয়েবসাইটে মুক্তিযুদ্ধের ইতিহাস এবং তথ্য।",
    },
    {
    ...
    },
    {
      ...
      snippet:
        "মুক্তিযুদ্ধের সময় আন্তর্জাতিক সম্প্রদায়ের প্রতিক্রিয়া এবং ভূমিকা।",
    },
    {
  ...
  if (queryLower.includes("পাকিস্তান") || queryLower.includes("সেনাবাহিনী")) {
    fallbackSources.push({
      ...
      snippet:
        "১৯৭১ সালে পাকিস্তান সেনাবাহিনীর ভূমিকা এবং কার্যক্রম সম্পর্কে গবেষণা।",
    });
  }
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(
      "মুক্তিযুদ্ধ কর্নার অনুরোধ প্রাপ্ত:",
      query,
      "ক্যাটাগরি:",
      category,
      "সাবক্যাটাগরি:",
    ...
    if (evidenceSources.length === 0) {
      console.log(
        "RapidAPI ফলাফল পাওয়া যায়নি, ফ্যালব্যাক রেফারেন্স তৈরি হচ্ছে..."
      );
      ...
      try {
        ...
        try {
          ...
          return NextResponse.json(
            {
              error:
                "No compatible Gemini model found. Please check your API key and model availability.",
            },
            { status: 500 }
          );
        }
...
Instead of: "এই দাবিটি অসত্য কারণ..."
...
Write at least 5-7 detailed paragraphs in DETAILED_ANALYSIS and provide your own expert conclusion in CONCLUSION section.`;
    ...
    return NextResponse.json(
      {
        error: "দাবি বিশ্লেষণ করতে ব্যর্থ",
        details: error instanceof Error ? error.message : "অজানা ত্রুটি",
      },
      { status: 500 }
    );
  }
...
function parseMuktiCornerResponse(
  response: string,
  query: string,
