...
export default function BlogPage() {
  ...
  const allTags = [
    "সব",
    ...Array.from(new Set(sortedBlogPosts.flatMap((post) => post.tags))),
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 font-tiro-bangla max-w-3xl mx-auto">
              ফ্যাক্টচেকিং, মুক্তিযুদ্ধের ইতিহাস, জলবায়ু পরিবর্তন এবং অন্যান্য
              গুরুত্বপূর্ণ বিষয়ে সঠিক তথ্য ও বিশ্লেষণ
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="text-center py-12">
            <div className="text-gray-500 font-tiro-bangla">
              ...
              <p className="text-sm mt-2">
                অনুগ্রহ করে আপনার অনুসন্ধান শব্দ বা ফিল্টার পরিবর্তন করুন
              </p>
            </div>
          </div>
        )}
