...
export const metadata: Metadata = {
  ...
  description:
    "বাংলা ভাষায় সত্যতা যাচাইয়ের জন্য AI-চালিত প্ল্যাটফর্ম। খবর, ছবি, লেখা এবং তথ্যের সত্যতা যাচাই করুন। অসত্য তথ্য প্রতিরোধ করুন।",
  keywords: [
    "খোঁজ",
    "Khoj",
    "বাংলা ফ্যাক্টচেকার",
  ...
  openGraph: {
    ...
    description:
      "বাংলা ভাষায় সত্যতা যাচাইয়ের জন্য AI-চালিত প্ল্যাটফর্ম। খবর, ছবি, লেখা এবং তথ্যের সত্যতা যাচাই করুন।",
