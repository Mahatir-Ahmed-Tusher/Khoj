    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-xl md:text-2xl font-bold mb-2 font-solaiman-lipi">
            ফ্যাক্টচেকিং রিপোর্ট লেখার গাইড
          </h1>
          <p className="text-sm md:text-base opacity-90 font-solaiman-lipi">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="text-center mb-6">
            ...
            <h2 className="text-lg font-bold text-gray-800 mb-3 font-solaiman-lipi">
              আমাদের পরিবারে স্বাগতম!
            </h2>
            <p className="text-sm text-gray-600 leading-relaxed font-solaiman-lipi">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-solaiman-lipi">শুরুর কথা</h3>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-600 leading-relaxed mb-4 font-solaiman-lipi">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 border border-green-200">
                <h4 className="text-sm font-semibold text-green-700 mb-2 font-solaiman-lipi">
                  কেন ফ্যাক্টচেকিং গুরুত্বপূর্ণ?
                </h4>
                <ul className="text-left text-gray-600 space-y-1 text-xs font-solaiman-lipi">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-solaiman-lipi">বিষয় নির্বাচন</h3>
            </div>
            <h4 className="text-base font-semibold text-gray-800 mb-3 font-solaiman-lipi">
              ভালো বিষয় নির্বাচনের জন্য:
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <h5 className="font-semibold text-blue-700 mb-2 text-sm font-solaiman-lipi">নির্বাচন করুন</h5>
                <ul className="space-y-1 text-gray-600 text-xs font-solaiman-lipi">
              ...
              <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                <h5 className="font-semibold text-red-700 mb-2 text-sm font-solaiman-lipi">এড়িয়ে চলুন</h5>
                <ul className="space-y-1 text-gray-600 text-xs font-solaiman-lipi">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-solaiman-lipi">গবেষণা</h3>
            </div>
            <h4 className="text-base font-semibold text-gray-800 mb-3 font-solaiman-lipi">
              গবেষণার ধাপসমূহ:
            </h4>
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  <h5 className="font-semibold text-gray-800 mb-1 text-sm font-solaiman-lipi">প্রাথমিক অনুসন্ধান</h5>
                  <p className="text-gray-600 text-xs font-solaiman-lipi">বিষয়টি সম্পর্কে মৌলিক তথ্য সংগ্রহ করুন এবং কী ধরনের প্রমাণ প্রয়োজন তা নির্ধারণ করুন।</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center font-bold text-xs">2</div>
                <div>
                  <h5 className="font-semibold text-gray-800 mb-1 text-sm font-solaiman-lipi">উৎস অনুসন্ধান</h5>
                  <p className="text-gray-600 text-xs font-solaiman-lipi">নির্ভরযোগ্য উৎস যেমন সরকারি প্রতিষ্ঠান, স্বীকৃত সংস্থা এবং বিশেষজ্ঞদের মতামত খুঁজে বের করুন।</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                <div className="w-6 h-6 bg-purple-500 text-white rounded-full flex items-center justify-center font-bold text-xs">3</div>
                <div>
                  <h5 className="font-semibold text-gray-800 mb-1 text-sm font-solaiman-lipi">তথ্য যাচাই</h5>
                  <p className="text-gray-600 text-xs font-solaiman-lipi">সংগৃহীত তথ্যের সত্যতা যাচাই করুন এবং বিভিন্ন উৎসের মধ্যে তুলনা করুন।</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-solaiman-lipi">রিপোর্ট লেখা</h3>
            </div>
            <h4 className="text-base font-semibold text-gray-800 mb-3 font-solaiman-lipi">
              রিপোর্টের গঠন:
            </h4>
            <div className="space-y-3">
              {reportStructure.map((section, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                  <h5 className="text-sm font-semibold text-gray-800 mb-1 font-solaiman-lipi">
                    {section.title}
                  </h5>
                  <p className="text-gray-600 mb-2 text-xs font-solaiman-lipi">
                    {section.description}
                  </p>
                  <div className="bg-gray-50 rounded p-3">
                    <p className="text-xs text-gray-700 italic font-solaiman-lipi">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-solaiman-lipi">জমা দেওয়া</h3>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 border border-green-200">
                <Mail className="w-8 h-8 text-green-500 mx-auto mb-3" />
                <h4 className="text-base font-bold text-gray-800 mb-3 font-solaiman-lipi">
                  রিপোর্ট জমা দেওয়ার নিয়ম
                </h4>
                <div className="space-y-3 text-left max-w-2xl mx-auto">
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    <h5 className="font-semibold text-gray-800 mb-1 text-sm font-solaiman-lipi">ইমেইল ঠিকানা:</h5>
                    <a 
                      href="mailto:sysitech1971@gmail.com"
                      className="text-blue-600 hover:text-blue-700 font-medium text-sm font-solaiman-lipi"
                    >
                  ...
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    <h5 className="font-semibold text-gray-800 mb-1 text-sm font-solaiman-lipi">ফাইল ফরম্যাট:</h5>
                    <div className="flex flex-wrap gap-1">
                      <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-solaiman-lipi">DOCX</span>
                      <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-solaiman-lipi">TXT</span>
                      <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-solaiman-lipi">Google Doc</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <h5 className="font-semibold text-yellow-800 mb-1 text-sm font-solaiman-lipi">গুরুত্বপূর্ণ মনে রাখবেন:</h5>
                        <p className="text-yellow-700 text-xs font-solaiman-lipi">
        ...
        {/* Tips Section */}
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <h3 className="text-lg font-bold text-gray-800 mb-4 text-center font-solaiman-lipi">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {tips.map((tip, index) => (
              <div key={index} className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 mb-1 text-sm font-solaiman-lipi">
                    {tip.title}
                  </h4>
                  <p className="text-gray-600 text-xs font-solaiman-lipi">
                    {tip.description}
                  </p>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg p-6 text-white text-center">
          <h3 className="text-lg font-bold mb-3 font-solaiman-lipi">
            এখনই শুরু করুন!
          </h3>
          <p className="text-sm mb-4 opacity-90 font-solaiman-lipi">
            আপনার প্রথম ফ্যাক্টচেকিং রিপোর্ট লিখুন এবং আমাদের পরিবারের অংশ হন
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a 
              href="mailto:sysitech1971@gmail.com"
              className="bg-white text-blue-600 hover:bg-gray-100 px-4 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg text-sm font-solaiman-lipi"
            >
              রিপোর্ট পাঠান
            </a>
            <Link 
              href="/"
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 px-4 py-2 rounded-full font-semibold transition-all duration-300 text-sm font-solaiman-lipi"
            >
              হোম পেজে ফিরুন
            </Link>
          </div>
