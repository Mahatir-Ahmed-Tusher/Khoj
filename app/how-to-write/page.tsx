  ...
  const reportStructure = [
    {
      ...
      example:
        "বাংলাদেশে করোনা ভ্যাকসিনের পার্শ্বপ্রতিক্রিয়া নিয়ে ভাইরাল হওয়া পোস্টটি সত্য নাকি মিথ্যা?",
    },
    {
      title: "দাবি/তথ্য",
      description:
      ...
      example:
        "সামাজিক যোগাযোগমাধ্যমে একটি পোস্ট ভাইরাল হয়েছে যেখানে বলা হয়েছে যে করোনা ভ্যাকসিন নেওয়ার পর অনেকেই গুরুতর পার্শ্বপ্রতিক্রিয়ায় ভুগছেন।",
    },
    {
      title: "যাচাই প্রক্রিয়া",
      description: "কীভাবে যাচাই করা হয়েছে তার বিস্তারিত বর্ণনা",
      example:
        "আমরা চিকিৎসা বিশেষজ্ঞদের সাথে কথা বলেছি, সরকারি স্বাস্থ্য বিভাগের তথ্য পর্যালোচনা করেছি এবং বিশ্ব স্বাস্থ্য সংস্থার রিপোর্ট বিশ্লেষণ করেছি।",
    },
    {
      title: "ফলাফল",
      description: "যাচাইয়ের চূড়ান্ত ফলাফল (সত্য/মিথ্যা/ভ্রান্তিমূলক)",
      example:
        "ভাইরাল হওয়া তথ্যটি ভ্রান্তিমূলক। ভ্যাকসিনের পার্শ্বপ্রতিক্রিয়া থাকলেও সেগুলো সাধারণত হালকা এবং সাময়িক।",
    },
    {
      title: "উৎসসমূহ",
      description: "যে সব উৎস ব্যবহার করা হয়েছে সেগুলোর তালিকা",
      example:
        "বাংলাদেশ স্বাস্থ্য অধিদপ্তর, বিশ্ব স্বাস্থ্য সংস্থা, চিকিৎসা বিশেষজ্ঞদের সাক্ষাৎকার।",
    },
  ];
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 leading-relaxed font-tiro-bangla">
              এতোদূর যেহেতু চলে এসেছেন, তাহলে নিশ্চয়ই আপনি আমাদের পরিবারের
              সদস্য হতে চান। চলুন জানা যাক, কীভাবে লিখা হয় একটি ফ্যাক্টচেকিং
              রিপোর্ট...
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-tiro-bangla">
                শুরুর কথা
              </h3>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-600 leading-relaxed mb-4 font-tiro-bangla">
                ফ্যাক্টচেকিং একটি গুরুত্বপূর্ণ কাজ যা সমাজে সত্যের প্রচার এবং
                অসত্য তথ্যের বিরুদ্ধে লড়াই করে। আমাদের সাথে যোগ দিয়ে আপনি এই
                মহৎ কাজে অংশগ্রহণ করতে পারেন।
              </p>
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 border border-green-200">
                ...
                <ul className="text-left text-gray-600 space-y-1 text-xs font-tiro-bangla">
                  <li>• অসত্য তথ্যের বিস্তার রোধ করে</li>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <h5 className="font-semibold text-blue-700 mb-2 text-sm font-tiro-bangla">
                  নির্বাচন করুন
                </h5>
              ...
              <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                <h5 className="font-semibold text-red-700 mb-2 text-sm font-tiro-bangla">
                  এড়িয়ে চলুন
                </h5>
                <ul className="space-y-1 text-gray-600 text-xs font-tiro-bangla">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  <h5 className="font-semibold text-gray-800 mb-1 text-sm font-tiro-bangla">
                    প্রাথমিক অনুসন্ধান
                  </h5>
                  <p className="text-gray-600 text-xs font-tiro-bangla">
                    বিষয়টি সম্পর্কে মৌলিক তথ্য সংগ্রহ করুন এবং কী ধরনের প্রমাণ
              ...
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-xs font-tiro-bangla">
                    নির্ভরযোগ্য উৎস যেমন সরকারি প্রতিষ্ঠান, স্বীকৃত সংস্থা এবং
                    বিশেষজ্ঞদের মতামত খুঁজে বের করুন।
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-xs font-tiro-bangla">
                    সংগৃহীত তথ্যের সত্যতা যাচাই করুন এবং বিভিন্ন উৎসের মধ্যে
                    তুলনা করুন।
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-3 text-left max-w-2xl mx-auto">
                  ...
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-1">
                      <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-tiro-bangla">
                        DOCX
                      </span>
                      <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-tiro-bangla">
                        TXT
                      </span>
                      <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-tiro-bangla">
                        Google Doc
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <h5 className="font-semibold text-yellow-800 mb-1 text-sm font-tiro-bangla">
                          গুরুত্বপূর্ণ মনে রাখবেন:
                        </h5>
                        <p className="text-yellow-700 text-xs font-tiro-bangla">
                          Google Doc ব্যবহার করলে অবশ্যই লিংকটি accessible করে
                          রাখুন। আমাদের যেন ফাইলটি দেখতে এবং সম্পাদনা করতে
                          সমস্যা না হয়।
                        </p>
                      </div>
                    </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {tips.map((tip, index) => (
              <div
                key={index}
                className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg hover:shadow-md transition-shadow"
              >
