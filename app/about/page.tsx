      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          ...
          <section className="card">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 font-solaiman-lipi">
              খোঁজ সম্পর্কে
            </h2>
          ...
          <section className="card">
            ...
            <div className="text-center mb-8">
              <p className="text-gray-600 font-solaiman-lipi mb-8">
          ...
          <section className="card text-center">
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href="mailto:mahatirtusher@gmail.com" className="text-primary-600 hover:text-primary-700 font-medium font-solaiman-lipi">
