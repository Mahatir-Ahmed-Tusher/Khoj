...
================================================================================
  ...
  const processReportHtml = (html: string) => {
    ...
    // Match "ভ্রান্ত (unverified)", etc. and keep only "ভ্রান্ত"
    processedHtml = processedHtml.replace(
      /(ভ্রান্ত)\s*\(?(unverified|unverified|unverified)\)?/gi,
      "বিভ্রান্তিকর"
    );
    ...
    processedHtml = processedHtml.replace(
      /\b(UNVERIFIED|Unverified|unverified|unverified|unverified|unverified)\b/g,
      "বিভ্রান্তিকর"
    );
                            ...
                            <span
                              className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${
                                normalizeVerdict(article.verdict) === "true"
                                  ? "bg-green-100 text-green-800"
                                  : normalizeVerdict(article.verdict) ===
                                      "false"
