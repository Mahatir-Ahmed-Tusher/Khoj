...
================================================================================
  ...
  const processReportHtml = (html: string, verdict: string) => {
    ...
    // Match "মিথ্যা (FALSE)", "মিথ্যা(FALSE)", "মিথ্যা (False)", etc. and keep only "মিথ্যা"
    processedHtml = processedHtml.replace(
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="hidden sm:flex items-center gap-2 sm:gap-3 flex-shrink-0">
                      <GenkitAudioPlayer
                        ...
                        onOptionsClick={() => setShowShareModal(true)}
                      />
                    </div>
                  </div>
