      ...
      <div className="py-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold text-blue-800 mb-2 font-tiro-bangla">Screen Width</h3>
                <p className="text-2xl font-bold text-blue-600">{screenSize}</p>
              </div>
              <div className={`p-4 rounded-lg ${isMobile ? 'bg-green-50' : 'bg-red-50'}`}>
                <h3 className={`font-semibold mb-2 font-tiro-bangla ${isMobile ? 'text-green-800' : 'text-red-800'}`}>
                  Hamburger Menu
                </h3>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 font-tiro-bangla">Breakpoint</th>
                    <th className="text-left py-2 font-tiro-bangla">Min Width</th>
                    <th className="text-left py-2 font-tiro-bangla">Hamburger Status</th>
                    <th className="text-left py-2 font-tiro-bangla">CSS Class</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-red-50 p-4 rounded-lg">
                <h3 className="font-semibold text-red-800 mb-2 font-tiro-bangla">Desktop (≥768px)</h3>
                <ul className="text-sm text-red-700 space-y-1 font-tiro-bangla">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold text-green-800 mb-2 font-tiro-bangla">Mobile (&lt;768px)</h3>
                <ul className="text-sm text-green-700 space-y-1 font-tiro-bangla">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <h2 className="text-xl font-semibold text-green-800 mb-4 font-tiro-bangla">
              Expected Results
            </h2>
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-2 font-tiro-bangla">Desktop Navigation</h3>
              ...
              <div className="bg-white p-4 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-2 font-tiro-bangla">Mobile Navigation</h3>
                <p className="text-sm text-gray-600 font-tiro-bangla">
