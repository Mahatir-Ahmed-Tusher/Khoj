      ...
      <div className="max-w-4xl mx-auto px-4">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left py-2 font-tiro-bangla">FAB Status</th>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-4">
            <h3 className="font-semibold text-blue-800 mb-2 font-tiro-bangla">Expanded FAB Features:</h3>
            <ul className="text-sm text-blue-700 space-y-1 font-tiro-bangla">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-semibold text-gray-800 mb-2 font-tiro-bangla">Desktop (≥1024px)</h3>
              <ul className="text-sm text-gray-600 space-y-1 font-tiro-bangla">
            ...
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-semibold text-gray-800 mb-2 font-tiro-bangla">Mobile (&lt;1024px)</h3>
              <ul className="text-sm text-gray-600 space-y-1 font-tiro-bangla">
