...
function MythbustingContent() {
  ...
  const [currentReport, setCurrentReport] = useState<SearchHistory | null>(
    null
  );
  ...
  const checkExistingData = async (
    ...
    // 1) Local cache first
    const localHistory = searchHistory.find(
    ...
    // 2) Convex database
    try {
      const convexResult = await convex.query(api.factChecks.getByQuery, {
        query,
      });
      if (convexResult) {
        ...
        const mapped: SearchHistory = {
          ...
          sources: (convexResult.sources || []).map(
            (source: any) =>
              ({
                id: source.id,
                title: source.title || "",
...
যাচাইকৃত: ${new Date().toLocaleString("bn-BD")}
  ...
  const loadReportFromHistory = async (report: SearchHistory) => {
    console.log(
      "[Flow] Loading report from history. Attempting Convex getByID for latest:",
      report.id
    );
    try {
      ...
      if (latest) {
        console.log(
          "[Convex] Found latest by id. Using DB version for render."
        );
        ...
        setMessages([
          ...
          },
          {
            ...
            ourSiteArticles: updated.ourSiteArticles,
          },
        ]);
        return;
      }
  ...
  return (
    <div className="min-h-screen text-justify bg-gray-50">
          ...
          <div className="lg:col-span-3">
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="flex justify-end mb-4 lg:hidden">
                  <button
                    ...
                    title={
                      isSidebarCollapsed ? "সাইডবার খুলুন" : "সাইডবার বন্ধ করুন"
                    }
                  >
                    {isSidebarCollapsed ? (
                      <>
                ...
                <p className="text-center text-gray-600 mb-6 font-tiro-bangla">
                  যেকোনো বৈজ্ঞানিক দাবি, ভূতুড়ে ঘটনা, কুসংস্কার বা
                  সিউডোসায়েন্স সম্পর্কে প্রশ্ন করুন। কৃত্রিম বুদ্ধিমত্তা
                  সম্পন্ন এই সার্চ ইঞ্জিন ব্যবহার করে সঠিক তথ্য খুঁজে পেতে
                  পারেন।
                </p>
                ...
                {/* Example Queries */}
                <div className="mt-6">
                  <p className="text-sm text-gray-500 mb-3 font-tiro-bangla">
                    উদাহরণ:
                  </p>
                  ...
                  <>
                    {messages.length === 0 ? (
                      <div className="text-center text-gray-500 font-tiro-bangla">
                        ...
                        <p className="text-lg">
                          আপনার প্রশ্নের উত্তর এখানে প্রদর্শিত হবে
                        </p>
                        <p className="text-sm mt-2">
                          উপরের সার্চ বক্সে আপনার প্রশ্ন লিখুন
                        </p>
                        {searchHistory.length > 0 && (
                          <div className="mt-4">
                            <p className="text-sm text-gray-400">
                              অথবা সাইডবার থেকে আগের রিপোর্ট লোড করুন
                            </p>
                            <button
                          ...
                          {message.isUser ? (
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="flex justify-between items-center">
                                  <div>
                                    ...
                                    {message.verdict && (
                                      <div className="mt-2">
                                        <span
                                          className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${getVerdictColor(message.verdict)}`}
                                        >
                              ...
                              <div className="p-6">
                                  ...
                                  <div className="mt-6 p-4 bg-red-50 rounded-lg border border-red-200">
                                    ...
                                    <div className="prose prose-lg max-w-none font-tiro-bangla">
                                      <div
                                        ...
                                        dangerouslySetInnerHTML={{
                                          __html: sanitizeHtml(
                                            parseMarkdown(message.conclusion)
                                          ),
                                        }}
                                      />
                                    </div>
                                ...
                                {/* Key Takeaways */}
                                {message.keyTakeaways &&
                                  message.keyTakeaways.length > 0 && (
                                    <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                      <h3 className="text-lg font-semibold text-yellow-900 mb-3 font-tiro-bangla">
                                        মূল বার্তা:
                                      </h3>
                                        ...
                                        {message.keyTakeaways
                                          ...
                                          .map((takeaway, index) => (
                                            ...
                                            >
                                              ...
                                              <p className="text-yellow-800 font-tiro-bangla leading-relaxed">
                                                {takeaway}
                                              </p>
                                            </li>
                                          ))}
            ...
            <div className="mt-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-800 font-tiro-bangla leading-relaxed">
                এই মিথবাস্টিং টুল বৈজ্ঞানিক দাবি, কুসংস্কার, ভূতুড়ে ঘটনা এবং
                সিউডোসায়েন্স সম্পর্কে সঠিক তথ্য প্রদান করে। আমরা বৈজ্ঞানিক
                গবেষণা এবং প্রমাণের ভিত্তিতে আপনার প্রশ্নের উত্তর দিই।
              </p>
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 z-50 lg:hidden ${isSidebarCollapsed ? "translate-x-full" : "translate-x-0"}`}
      >
        <div className="h-full flex flex-col">
          {/* Header */}
          <div className="flex-shrink-0 p-4 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-bold text-gray-600 font-tiro-bangla">
                সার্চ হিস্টরি
              </h3>
              <button
                onClick={() => setIsSidebarCollapsed(true)}
